...
using ValiShop.Data;
using ValiShop.Models.RealEstate;

namespace ValiShop.Controllers
{
    public class RealEstatesController : Controller
    {
        ...
        public RealEstatesController(IRealEstatesServices realEstatesServices, ValiShopContext context, IFilesServices filesServices)
        {
