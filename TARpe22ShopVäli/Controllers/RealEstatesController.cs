...
using TARpe22ShopVäli.Models.RealEstate;
...
namespace TARpe22ShopVäli.Controllers
{
    public class RealEstatesController : Controller
    {
        ...
        public RealEstatesController(IRealEstatesServices realEstatesServices, TARpe22ShopVäliContext context, IFilesServices filesServices)
        {
